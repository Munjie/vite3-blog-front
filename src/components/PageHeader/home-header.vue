...
/*const getBgCover = computed(() => {
  ...
  // 做一个根据路由来判断判断页面背景图片
  let url;
  let myUrl = "http://qiniu.munjie.com/scifi_postapocalyptic_world_20250806060407_01.png?e=1754490442&token=b-lHQMCnIt3TO4P7QL1hVM06sm2cxAqN-53uwWDe:ZQnSQsxmYOE1I3jn-ztqPdisRwg=";
